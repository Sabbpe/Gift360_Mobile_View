...
import { AlertCircle, ShieldCheck, ArrowUpRight, ChevronRight, Mail } from "lucide-react";
  ...
  return (
    <main className="gift-page">
        ...
        <section className="login-card">
          <div className="card-heading">
            <div>
              ...
              <p>Create your account to start gifting</p>
            </div>
          </div>
          ...
          {!otpSent ? (
            ...
            >
              {registerSendOtpMutation.isPending ? "Sending..." : <>Send OTP <ArrowUpRight size={20} /></>}
            </button>
          ) : (
            <div className="otp-section">
              ...
              >
                {registerVerifyOtpMutation.isPending ? "Verifying..." : <>Verify &amp; Create Account <ArrowUpRight size={18} /></>}
              </button>
              <p className="resend">
                Didn't receive?{" "}
      ...
      <style>{`
        ...
        .error-alert { display:flex; align-items:center; gap:8px; padding:8px 10px; border-radius:12px; margin-bottom:12px; font-size:10px; font-weight:500; border:1px solid rgba(220,38,38,0.3); background:rgba(220,38,38,0.08); color:rgb(220,38,38); }
        ...
        .field-icon { margin-left:14px; flex:none; font-size:16px; }
